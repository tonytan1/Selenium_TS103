...
//		Navigator.waitForAjaxElementLoad(driver, by);
	...
	public void UpdateExtRec_UI(WebDriver driver, String action) {
		...
		if (!str.equals("")) {
			String xpath_calendar = "//tr[descendant::td/b[contains(text(),'Start')]]/td[2]/div/div[2]/a/img[@alt='Calendar']";
			WebDriverUtils.dateSelect_Calandar(driver, str, xpath_calendar);
		}

		str = this.getEndDate();
		if (!str.equals("")) {
			String xpath_calendar = "//tr[descendant::td/b[contains(text(),'End')]]/td[2]/div/div[2]/a/img[@alt='Calendar']";
			WebDriverUtils.dateSelect_Calandar(driver, str, xpath_calendar);
		}
		...
		String msg = "";
		if (str.equals(Config.getInstance().getProperty("label.pendingApproval"))) {
			msg = Config.getInstance().getProperty("msg.pendingApprWarn");
		...
		if (action.equals("CREATE")) {
			...
			msg = Config.getInstance().getProperty(
					"msg.externalCreateSuccessful");
			// by =
