...
public class HomeTemplate extends com.netdimen.abstractclasses.TestObject {
	...
	public void setModules_UI(WebDriver driver, String str) {
		if (!str.equals("")) { //
			HashMap<String, ArrayList<String>> section_column_values = UIFunctionUtils.parseParticipants(str); //section0 -> Column1:My Team;Course Status;
			...
			while(ite_section.hasNext()){
				...
				for(String column_value: column_values){
					HashMap<String, ArrayList<String>> column_values_map = UIFunctionUtils.parseParticipants(column_value);//column1 -> My Team;Course Status;
					...
					while(ite_column.hasNext()){
						...
						ArrayList<String> values = column_values_map.get(column);
						for(String value: values){
							String[] modules = value.split(";");
							for(String module: modules){
								src = By.xpath("//div[@id='widgetLibraryDiv']/ul/li[contains(text(),'"+ module +"')]");
								size = WebDriverUtils.getHowManyByPresntInPage(src);
	...
	public void setColumns_UI(WebDriver driver, String str){
		if(!str.equals("")){
			HashMap<String, ArrayList<String>> section_columns = UIFunctionUtils.parseParticipants(str); //section0 -> 1 Column;
	...
	public void runCreate(WebDriver driver) {
		...
		By by = By.xpath("//button[@title='Create new template']");
		WebDriverUtils.clickButton(driver, by);
