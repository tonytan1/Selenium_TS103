...
public class PerformanceGoal extends com.netdimen.model.Goal {
	...
	public void runCreate(WebDriver driver) {
		...
		By by = By
				.xpath("//button[descendant::span[text()='Create performance goal']]");
		Navigator.waitForAjax(driver, by);
		WebDriverUtils.clickButton(driver, by);
		...
		by = By.linkText(this.getGoalTitle());
		Navigator.waitForAjax(driver, by);
		int size = WebDriverUtils.getHowManyAjaxByPresentInPage(by);
...
/*	
	...
	public String toString() {
		...
		return new StringBuilder().
				...
				append(this.getUID()).
				append("_").
				append(this.getGoalTitle()).
				append("_").
				append(this.getProgramName()).				
				toString();
	}*/
