...
import com.netdimen.utils.WebDriverUtils.PopUpSelector;
...
//		Navigator.explicitWait();
	...
	public void runCheckReport(WebDriver driver){
		...
		while(users.hasNext()){
			...
			for(String attr_str: attrs){
				String[] attrs_array = attr_str.split(";");
				for(String attr: attrs_array){
	...
	public void setFields_UI(WebDriver driver, String fields){
		if(!fields.equals("")){
			By by = null;
			HashMap<String, ArrayList<String>> cata_fields = 
			...
			while(catas.hasNext()){
				...
				for(String fieldStr: fieldList){
					String[] fieldArray = fieldStr.trim().split(";");
					for(String field: fieldArray){
						xpath = "//td[descendant::dfn/label[contains(text(),'"+field.trim()+"')]]/input[@type='CHECKBOX']";
						by = By.xpath(xpath);
	...
	public void setQuestion_UI(WebDriver driver, String question){
		if(!question.equals("")){
			...
			WebDriverUtils.clickLink(driver, by);
			WebDriverUtils.switchToPopUpWin(driver);
			WebDriverUtils.searchSelect_Selector(driver, question);
			WebDriverUtils.switchToParentWin(driver);
			WebDriverUtils.switchToFrame(driver, "REPORT_MAIN_FRAME");
		}
	}
	...
	public void setExam_UI(WebDriver driver, String exam){
		if(!exam.equals("")){
			...
			WebDriverUtils.clickLink(driver, by);
			WebDriverUtils.switchToPopUpWin(driver);
			WebDriverUtils.searchSelect_Selector(driver, exam);
			WebDriverUtils.switchToParentWin(driver);
			WebDriverUtils.switchToFrame(driver, "REPORT_MAIN_FRAME");
		}
	}
	...
	public void setSubject_UI(WebDriver driver, String subject){
		if(!subject.equals("")){
			...
			WebDriverUtils.clickLink(driver, by);
			WebDriverUtils.switchToPopUpWin(driver);
			WebDriverUtils.searchSelect_Selector(driver, subject);
			WebDriverUtils.switchToParentWin(driver);
			WebDriverUtils.switchToFrame(driver, "REPORT_MAIN_FRAME");
		}
	} 
	...
	public void setUser_UI(WebDriver driver, String str){
		if(!str.equals("")){
			...
			keywords.add(str);
			WebDriverUtils.searchSelect_Selector(driver, PopUpSelector.InnerUserSelector, keywords);
