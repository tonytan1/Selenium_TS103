...
*/
	...
	public void setisPoll_UI(WebDriver driver, String str) {
		...
		if (str.equalsIgnoreCase("yes")) {
			...
			WebDriverUtils.searchSelect_Selector(driver, this.getSurvey());
	...
	public void setTargetAudience_UI(WebDriver driver, String str) {
		if (!str.equalsIgnoreCase("")) {
			By by = By.xpath("//span[contains(text(),'"+Config.getInstance().getProperty("tab.Target_Audience")+"')]");
	...
	public void runSubmitAndCheckPoll(WebDriver driver) {
		...
		// 3. Check statistic
		HashMap<String, ArrayList<String>> answer_statistics = UIFunctionUtils
		...
		while (answers.hasNext()) {
			...
			for (String statisticStr : statistics) {
				for (String expectedStatistic : statisticStr.split(";")) {
