...
public class EnrollmentPolicy extends Template {
	...
	public void runCreate(WebDriver driver){
		...
		// Edit policy detail		
		by = By.xpath("//a[contains(text(),'" + this.getName() + "')]/following-sibling::a[contains(text(),'"+Config.getInstance().getProperty("text.EditPolicy")+"')]");
		WebDriverUtils.clickLink(driver, by);
		WebDriverUtils.switchToFrame(driver, "POLICYMAIN");
		...
		WebDriverUtils.switchToFrame(driver, "POLICYTREE");
		this.expandPolicy_UI(driver, this.getName());
		by = By.xpath("//a[contains(text(),'" + this.getName() + "')]/following-sibling::a[contains(text(),'"+Config.getInstance().getProperty("text.EditWithdraw")+"')]");
		WebDriverUtils.clickLink(driver, by);
