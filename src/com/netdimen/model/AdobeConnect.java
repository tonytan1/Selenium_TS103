...
public class AdobeConnect extends com.netdimen.model.Classroom{
	...
	public void runCreate(WebDriver driver, ArrayList<TestObject> inputs){
		Properties prop= PropertiesFileUtil.loadProperties(Config.getInstance().getProperty("AdobeAccountConfFile"));
	 ...
	 * @param driver
	 */
	public void runSetupAndLaunchAdobeConnect(WebDriver driver){
