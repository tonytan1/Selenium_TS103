...
public class Forum extends com.netdimen.abstractclasses.TestObject {
	...
	public void setForumID_UI(WebDriver driver, String str) {
		if (!str.equals("")) {
			...
			if (size == 0) {
				...
				By byTemp = By.xpath("//input[@type='SUBMIT' and @value='"+Config.getInstance().getProperty("desc.Create_New_Forum")+"']");
	...
	public void runLaunchForumInKC(WebDriver driver) {
		...
		if (!this.getTopicSubject().equals("")
			...
			by = By.xpath("//input[@type='SUBMIT' and @value='"+Config.getInstance().getProperty("button.Post_New_Topic")+"']");
